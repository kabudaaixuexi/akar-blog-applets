import { injectable, inject, optional, ContainerModule, multiInject, Container } from 'inversify';
import { isObject as isObject$1, warn, isArray as isArray$1, toCamelCase, ensure, toDashed, isUndefined, isString, EMPTY_OBJ, isFunction as isFunction$1, controlledComponent, internalComponents, defaultReconciler, noop, isBoolean } from '@tarojs/shared';
...
const document$1 = getElement(ElementNames.Document)();
