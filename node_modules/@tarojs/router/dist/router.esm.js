...
function createRouter(app, config, framework) {
    ...
    const render = throttle(async ({ location, action }) => {
        ...
        if (shouldLoad) {
            ...
            delete config['path'];
            delete config['load'];
            const page = createPageConfig(enablePullDownRefresh ? (_d = runtimeHooks.createPullDownComponent) === null || _d === void 0 ? void 0 : _d.call(runtimeHooks, el, location.pathname, framework, routerConfig.PullDownRefresh) : el, location.pathname + stringify(qs(stacks.length)), {}, config);
    ...
    render({ location: history.location, action: m.Push });
