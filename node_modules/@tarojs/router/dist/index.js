...
function createRouter(app, config, framework) {
    ...
    var router = new UniversalRouter(routes, { baseUrl: config.router.basename || '' });
    app.onLaunch();
    var render = throttle(async function (ref) {
        ...
        if (shouldLoad) {
            ...
            var page = runtime.createPageConfig(enablePullDownRefresh ? (_d = runtimeHooks.createPullDownComponent) === null || _d === void 0 ? void 0 : _d.call(runtimeHooks, el, location.pathname, framework, routerConfig.PullDownRefresh) : el, location.pathname + runtime.stringify(qs(stacks.length)), {}, config$1);
    ...
    render({ location: exports.history.location, action: m.Push });
